...
public class AggiuntaAcquistoSingolo extends JDialog {
Controller TheController;

	/**
	 * Create the dialog.
	 */
	public AggiuntaAcquistoSingolo(Controller c) {
		TheController= c;
		...
		panel.add(icon);
		Image icona= new ImageIcon(this.getClass().getResource("/acquistosingolo.png")).getImage();
		icon.setIcon(new ImageIcon(icona));
		
		JLabel icona2 = new JLabel("");
		icona2.setBounds(401, 41, 33, 41);
		panel.add(icona2);
		Image iconaa= new ImageIcon(this.getClass().getResource("/acquistosingolo.png")).getImage();
